...
**Weird combos.** It's fine to make a check with weird combos. People are exceptional at creative application of the tools they have, and Evening characters are no different. That [[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Prowess]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/aptitudes/Arcana]] check makes a lot of sense in some scenarios, surely.
...
![[rulebooks/abandoned-wip-reference/evening-core-v1/tables/Table - Aptitudes]]
