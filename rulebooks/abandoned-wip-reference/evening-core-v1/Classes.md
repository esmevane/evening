...
tags:
  ...
  - systems
---
Every character brings something unique to the table, regardless of their origins. Different skills and approaches, different roles to play, and everyone changes the overall mix of their peers in their own way. Character classes are the part of [[rulebooks/abandoned-wip-reference/evening-core-v1/Progression|feature progression]] which describe the distinct way in which a character interacts with the overall setting and game world. 
...
- *Starting health.* The base health this class grants to a character, plus ([[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Resolve]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]]) x3.
...
- *Health.* Whenever a character increases their class rank, their health increases by this amount. This is a die, plus ([[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Resolve]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]]).
...
![[rulebooks/abandoned-wip-reference/evening-core-v1/tables/Table - Class Progression]]
