...
The rest of the group are *players*. Each player constructs one character (see [[rulebooks/abandoned-wip-reference/evening-core-v1/Character Creation]]), and plays that character. The players are in charge of engaging with the game, working together, dealing with in-game tensions, and moving the story forward.
