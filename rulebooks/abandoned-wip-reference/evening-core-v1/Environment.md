...
**Suffocation.** You can hold your breath for a number of minutes equal to 1 + [[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Resolve]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]], but no less than 30 seconds.

Whenever you run out of breath or begin choking, you may survive a number of *rounds* equal to 1 + [[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Resolve]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]], with a minimum of 1 round. At the start of the next turn, you drop to 0 health and begin dying, and you can't regain health or be stabilized until you can breathe again.
...
- In heavily obscured areas, such as darkness, thick fog, and so on, your vision is blocked entirely. You have the [[rulebooks/abandoned-wip-reference/evening-core-v1/Conditions#Blinded|blinded]] condition.
