...
**Load capacity.** Your load capacity is an abstract number that limits what you can carry. It starts at 4 + [[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Prowess]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]], and has no cap, with a minimum of a load capacity of 2.
