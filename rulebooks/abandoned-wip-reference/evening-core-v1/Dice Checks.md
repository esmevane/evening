...
![[rulebooks/abandoned-wip-reference/evening-core-v1/tables/Table - Target Numbers]]
...
**Take effect.** If a check succeeds, it *takes effect*. Usually, this means you get a standard effect. However, effect varies on a number of factors. See the [[rulebooks/abandoned-wip-reference/evening-core-v1/Effect|effect]] section for more information.
