...
At the end of the short rest, your character may spend some of their [[rulebooks/abandoned-wip-reference/evening-core-v1/Reserves|reserves]] in order to recover health. Roll a number of die for each reserve spent, adding your [[rulebooks/abandoned-wip-reference/evening-core-v1/abilities/Resolve]] + [[rulebooks/abandoned-wip-reference/evening-core-v1/attributes/Body]] to the result of each. Your character regains that much health.
